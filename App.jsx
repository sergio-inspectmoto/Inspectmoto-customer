...
const PACKAGES = [
  {
    ...
    includes: ["Documents & RC verification","Full exterior check","Engine bay inspection","Interior & electricals","Test drive assessment","Detailed PDF report on WhatsApp","Overall condition rating","Inspector recommendation"],
  ...
  },
  {
    ...
    includes: ["Everything in Basic","OBD/DTC diagnostic scan","Photo evidence in report","Detailed PDF report on WhatsApp","Inspector recommendation"],
...
const SERVICES = [
  ...
  { icon: "🚗", title: "Pre-Sale Inspection", desc: "Selling your vehicle? Get certified to command a better price.", items: ["Full condition report","Honest value assessment","Issues identified before listing","InspectMoto certification","Builds buyer trust","PDF report for listing"], color: "#c98a1e" },
];
