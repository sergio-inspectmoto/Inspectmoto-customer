...
const PACKAGES = [
  {
    name: "Basic",
    price: "₹999",
    desc: "Full inspection + PDF report",
    popular: false,
    includes: [
      "Documents & RC verification",
      "Full exterior check (paint, dents, rust, glass, tires)",
      "Engine bay inspection (oil, coolant, belts, leaks)",
      "Interior & electricals (AC, windows, dashboard, horn)",
      "Test drive assessment (brakes, clutch, suspension)",
      "Detailed PDF report sent to WhatsApp",
  ...
  },
  {
    name: "Standard",
    price: "₹1,499",
    desc: "Basic + OBD scan + photos",
    popular: true,
    includes: [
      "Everything in Basic",
      "OBD/DTC diagnostic scan (hidden error codes)",
      "Photo evidence for every section in report",
      "Detailed PDF report sent to WhatsApp",
      "Overall condition rating",
      "Inspector recommendation",
    ],
  ...
  },
  {
    name: "Premium",
    price: "₹2,199",
    desc: "Standard + video + negotiation notes",
    popular: false,
    includes: [
      "Everything in Standard",
      "Test drive video recording",
      "Negotiation leverage summary",
      "Price fair value assessment",
      "Detailed PDF report sent to WhatsApp",
      "Priority inspection slot",
    ],
    notIncludes: [],
  },
];
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", background: "#fff", minHeight: "100vh", boxShadow: "0 0 24px rgba(0,0,0,0.06)" }}>
        ...
        <div style={{ background: navy, color: "#fff", padding: "16px 20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <img src={LOGO} alt="InspectMoto" style={{ width: 42, height: 42, borderRadius: "50%", objectFit: "cover", border: "2px solid rgba(255,255,255,0.2)" }} />
            <div>
              <div style={{ fontSize: 19, fontWeight: 800 }}>InspectMoto</div>
        ...
        {/* Hero */}
        <div style={{ background: `linear-gradient(135deg, ${navy} 0%, #0f3460 100%)`, color: "#fff", padding: "24px 20px 22px", textAlign: "center" }}>
          <img src={LOGO} alt="InspectMoto Logo" style={{ width: 72, height: 72, borderRadius: "50%", objectFit: "cover", border: "3px solid rgba(255,255,255,0.25)", marginBottom: 12 }} />
          <div style={{ fontSize: 21, fontWeight: 900, lineHeight: 1.2, marginBottom: 8 }}>Know before you buy. 🔍</div>
        ...
        {tab === "book" && !submitted && (
          <div style={{ padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 18 }}>
              {PACKAGES.map((p) => (
                <div key={p.name}>
                  <div onClick={() => setPkg(p.name)} style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        <div onClick={(e) => { e.stopPropagation(); setSelectedPkg(p); }} style={{ fontSize: 11, color: "#1d7a4c", fontWeight: 700, marginTop: 3, cursor: "pointer" }}>
                          What's included? ›
                        </div>
                      </div>
                    </div>
                ...
                {expandedService === i && (
                  <div style={{ background: "#f9f8f5", padding: "12px 16px", borderTop: "1px solid #eee" }}>
                    ...
                    <button onClick={() => setTab("book")} style={{
                      marginTop: 12, width: "100%", background: s.color, color: "#fff",
                      border: "none", borderRadius: 8, padding: "10px 0", fontSize: 13.5,
